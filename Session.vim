...
silent only
cd ~/Desktop/rcnn/keras
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +2695 keras/engine/training.py
badd +319 keras/engine/topology.py
badd +900 keras/layers/core.py
argglobal
silent! argdel *
edit keras/engine/topology.py
...
let s:l = 587 - ((10 * winheight(0) + 26) / 52)
